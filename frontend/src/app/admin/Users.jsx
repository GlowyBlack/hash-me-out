...
export default function Users() {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-6" ref={searchRef}>
      <h1 className="text-gray-800 text-3xl font-bold mb-6">User Management</h1>
      ...
      <input
        ...
        className="w-full px-4 text-gray-800 py-2 mb-4 border border-gray-300 rounded-lg bg-gray-50"
      />
